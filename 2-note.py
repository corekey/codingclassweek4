...
# 2: This is the beginning of while loop
game_on = True
while game_on:
    ...
    #2: This is the for loop to check the key events
    for event in pygame.event.get():
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                game_on = False
            elif event.key == pygame.K_LEFT:
                player_x = player_x - 10   # 1: faster skiing
            elif event.key == pygame.K_RIGHT:
                player_x = player_x + 10   # 1: faster skiing
            elif event.key == pygame.K_UP:
                player_y = player_y - 10   # 1: faster skiing
